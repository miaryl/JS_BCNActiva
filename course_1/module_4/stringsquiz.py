...
print("----------------------------------------------------------------------")
weather = "Rainfall"  #want to print "Rain"
...
print(weather[4:]) # fall



print(weather[1:4]) # ain



#print(weather[:"f"]) # typeerror 
...
only the substring at the end of the sentence is replaced. For example, replace_ending("abcabc", "abc", "xyz") should return abcxyz, 
